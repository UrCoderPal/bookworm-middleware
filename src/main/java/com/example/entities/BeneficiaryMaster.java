...
public class BeneficiaryMaster {
	...
	private List<ProductBenMaster> productBenMaster;
	...
	public List<ProductBenMaster> getProductBenMaster() {
		return productBenMaster;
	}

	public void setProductBenMaster(List<ProductBenMaster> productBenMaster) {
		this.productBenMaster = productBenMaster;
	}
